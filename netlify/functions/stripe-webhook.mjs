...
<div style="background:#fff;border:1px solid #e6e4dc;border-radius:14px;padding:18px;margin-bottom:16px;"><h3 style="margin:0 0 8px;font-size:17px;">${delivery ? 'Livraison' : 'À emporter'}</h3><p style="margin:0;color:#555;font-size:14px;">${addr}</p>${!delivery ? '<p style="margin:8px 0 0;color:#999;font-size:13px;">Votre commande sera prête dans 30 à 45 minutes.</p>' : ''}${o.instructions ? `<p style="margin:8px 0 0;color:#555;font-size:13px;">Note : ${esc(o.instructions)}</p>` : ''}</div>
